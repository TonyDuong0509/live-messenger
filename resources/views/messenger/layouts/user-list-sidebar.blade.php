<div class="wsus__user_list">
    <div class="wsus__user_list_header">
        <h3>
            <span style="width: 50px;"><a href="{{ url('/') }}">
                    <img src="{{ asset('assets/images/chat_list_icon.jpg') }}" alt="Chat" class="img-fluid"></a></span>
            Zalo Chat
        </h3>
