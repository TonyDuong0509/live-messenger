        ...
        <div class="wsus__chat_area">
            ...
            <div class="wsus__chat_area_footer">
                <div class="footer_message">
                    ...
                    <form action="" class="messenger-form" enctype="multipart/form-data">
                        <div class="file">
                            <label for="file"><i class="far fa-plus"></i></label>
                            <input id="file" type="file" hidden class="attachment-input" name="attachment"
                                accept="image/*">
                        </div>
                        <textarea id="example1" rows="1" placeholder="Soạn tin nhắn..." name="message" class="message-input"></textarea>
